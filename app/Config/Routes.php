...
$routes->post('api/member/add', 'MemberController::store');
$routes->add('api/member/(:segment)/edit', 'MemberController::show/$1');
$routes->post('api/member/(:segment)/update', 'MemberController::update/$1');
$routes->get('api/member/(:segment)/delete', 'MemberController::destroy/$1');
